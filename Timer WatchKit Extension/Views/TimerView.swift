...
struct TimerView: View {
    ...
    private var progressView: some View {
        ...
        .frame(width: WKInterfaceDevice.current().screenBounds.width * 0.75,
               height: WKInterfaceDevice.current().screenBounds.height * 0.75)
    }
...
struct TimerView_Previews: PreviewProvider {
    static var previews: some View {
        TimerView(timerModel: TimerModel(time: 1, unit: .min))
    }
}
